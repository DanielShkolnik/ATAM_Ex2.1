...
array_to_file:
    ...
    call itoa_hex
		movq (%rax), %r8
		movq %r8, ArrStr(,%rcx,1) # first 4 bytes of char* to ArrStr[j]
		movq 4(%rax), %r8
		movq $4, %r10
		movq %r8, ArrStr(%r10,%rcx,1) # middle 4 bytes of char* to ArrStr[j+4]
		movb 8(%rax), %r9b
		movq $8, %r10
		movb %r9b, ArrStr(%r10,%rcx,1) # last byte of char* to ArrStr[j+8]
		inc %r14 # i++
		addq $9, %rcx # j+=9
    cmp %r14, %r15
